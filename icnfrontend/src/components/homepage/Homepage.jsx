...
const Navbar = () => {
  ...
  return (
    <div className="relative bg-[rgb(2,28,51)]">
      <button
      ...
      <PageTransition in={true}>
        <div>
          ...
          <main>
            ...
            <section id="services-section" className="pt-5 fade-in-up">
              <Service />
            </section>
            <section id="blogs-section" className="pt-20 fade-in-up">
              <Blogs />
            </section>
            <section id="projects-section" className="pt-5 fade-in-up">
              <Project />
            </section>
            <section id="collaboration-section" className=" fade-in-up">
              <Collaboration />
            </section>
            <section id="about-section" className=" fade-in-up">
              <Aboutus />
            </section>
           
            <section id="help-section" className=" fade-in-up">
              <Help />
            </section>
          </main>
        <Footer />
